...
func (_m *PasswordHasher) Compare(hash string, plain string) error {
...
//   - hash string
//   - plain string
func (_e *PasswordHasher_Expecter) Compare(hash interface{}, plain interface{}) *PasswordHasher_Compare_Call {
